...
public class MapActual extends Fragment implements
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button step_history_back_button =  getView().findViewById(R.id.map_actual_back_button);
        ...
        mapView = getView().findViewById(R.id.mapViewCurrent);
...
// Set the component's render mode
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<MapActual> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(MapActual activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
            MapActual activity = activityWeakReference.get();
